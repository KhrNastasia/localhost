        ...
        <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            ...
            {id: 3, name: "Clementine Bauch", email: "Nathan@yesenia.net"}
                ...
                <button @click="open = !open"
                        class="min-w-[100px] max-w-[110px] px-4 py-2 rounded flex items-center justify-between">
                    <span class="max-w-[120px] overflow-hidden">Услуги</span>
                ...
                <div x-show="open" class="absolute mt-2 bg-white border rounded w-full z-10" style="display: none;">
                    <ul class="overflow-auto [&amp;>li]:text-gray-500 [&amp;>li]:px-4 [&amp;>li]:py-2 hover:[&amp;>li]:bg-gray-100 [&amp;>li]:cursor-pointer">
                        <template x-for="catalog in catalogs" :key="catalog.id">
                            <li><a class="text-amber-900 text-xl" href="http://vnedorog.by/service/1"
                                   x-text="catalog.name"></a></li>
                        </template>
                    </ul>
                </div>
            </div>
...
<section class="text-gray-600 body-font overflow-hidden" x-data="{
    product:null,
    getProduct(){
        fetch('http://127.0.0.1:8000/api/product/4')
        .then((responce)=>responce.json())
        .then((json)=>this.product=json);
    },
}" x-init="getProduct()">
    <div class="container px-5 py-24 mx-auto" x-cloak>
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" x-cloak
                 :src="`${product.pic_full_path[0]}`">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                <h2 class="text-sm title-font text-gray-500 tracking-widest" x-cloak
                    x-text="product.catalog_name"></h2>
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1" x-cloak x-text="product.name"></h1>
                <div class="flex mb-4">
